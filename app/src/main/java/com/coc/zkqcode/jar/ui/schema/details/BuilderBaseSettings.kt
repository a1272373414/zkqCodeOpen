...
object BuilderBaseSettings {
    ...
    // 夜世界下兵方案：
    //   0/缺省 = 源项目保真方案（即方案2：函数123a/323a/128a 移植）
    //   1      = 当前方案（主世界几何+点选落点）
    //   2      = 方案2（与 0 相同，显式标记）
    //   3      = 方案3（卡位式从左到右、白框识别、点落点4次、最多6轮）
    val NIGHT_WORLD_DEPLOY_PLAN = SettingDef("night_world_deploy_plan", "夜世界下兵方案(0=源方案,1=当前方案,2=方案2,3=方案3)", 0, "BUILDER_BASE_SETTINGS")
