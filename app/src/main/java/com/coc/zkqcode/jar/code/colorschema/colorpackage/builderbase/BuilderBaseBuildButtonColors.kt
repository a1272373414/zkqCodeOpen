...
/**
 * Build/upgrade button markers for the builder base (night village).
 *
 * Previously these were hardcoded inline inside BuilderBaseFindBuildingButton.kt; they live
 * here now so that every color definition of the project stays inside the colorschema package.
 */
interface IBuilderBaseBuildButtonColors {
    val BuilderBaseBuildTick1: ColorSchema
    val BuilderBaseBuildTick2: ColorSchema
    val BuilderBaseBuildTick3: ColorSchema
    val BuilderBaseBuildTick4: ColorSchema
    val BuilderBaseBuildTick5: ColorSchema
    val BuilderBaseBuildTick6: ColorSchema
    val BuilderBaseBuildTick7: ColorSchema
    val BuilderBaseBuildTick8: ColorSchema
    val BuilderBaseBuildTick9: ColorSchema
    val BuilderBaseBuildTick10: ColorSchema
    val BuilderBaseBuildCross1: ColorSchema
    val BuilderBaseBuildCross2: ColorSchema
    val BuilderBaseBuildCross3: ColorSchema
    val BuilderBaseBuildCross4: ColorSchema
    val BuilderBaseBuildCross5: ColorSchema
    val BuilderBaseBuildCross6: ColorSchema
    val BuilderBaseBuildCross7: ColorSchema
    val BuilderBaseBuildCross8: ColorSchema
    val BuilderBaseBuildCross9: ColorSchema
    val BuilderBaseBuildCross10: ColorSchema
}

object BuilderBaseBuildButtonColors : IBuilderBaseBuildButtonColors {
    // Green ticks shown on a buildable / upgradeable building (10 appearance variants)
    override val BuilderBaseBuildTick1 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildTick2 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildTick3 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildTick4 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildTick5 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildTick6 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildTick7 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildTick8 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildTick9 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildTick10 = ColorSchema.parse(
    ...
    // Red crosses shown when the resource cost cannot be paid (10 appearance variants)
    override val BuilderBaseBuildCross1 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildCross2 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildCross3 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildCross4 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildCross5 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildCross6 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildCross7 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildCross8 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildCross9 = ColorSchema.parse(
    ...
    override val BuilderBaseBuildCross10 = ColorSchema.parse(
        105, 60, 1115, 680, "6D60BA", "3|0|6E61BB,7|0|6D61BC,10|0|6E62BD,15|8|726BC9,16|15|0F0BAD,13|18|0F0CB2,5|18|0F0CB2,2|18|0E0CB1,-1|16|0E0BAB", 0, 0.92, "红色叉叉10"
    )
}
