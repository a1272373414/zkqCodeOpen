...
object MainBaseTrainCardColors : IMainBaseTrainCardColors {
    ...
    override val TrainCard战球 = ColorSchema.parse(
        23, 429, 1279, 693, "383D43",
        "-2|-7|52545C,8|2|31363B,38|2|5E6972,37|-6|A3B4B8,48|1|2C3045,59|-5|9DAFB3,17|-23|324CFF,-25|-61|5C568C,30|-81|5C68FF,73|-64|616DDA,14|-118|5568FF,62|-97|6EA1FF",
        0, 0.9, "战球训练卡片(造战球)"
    )
    ...
    override val TrainCard战车 = ColorSchema.parse(
        23, 429, 1279, 693, "273359",
        "6|-5|28365C,60|3|395A97,60|-4|3C61A2,123|-4|45454B,119|-37|6A6871,147|-20|716F6F,4|-31|303F67,3|-66|262D8B,16|-82|2E3394,66|-38|20267B,67|-63|142078,101|-90|376CC8",
        0, 0.9, "战车训练卡片(造战车)"
    )
    ...
    override val TrainCard猎手 = ColorSchema.parse(
        23, 429, 1279, 693, "6CF7FF",
        "3|-3|0D0D0F,12|8|4EF4FF,17|11|11141C,25|-11|955B68,37|-4|A66069,44|8|69FFFF,42|2|151210",
        0, 0.9, "猎手训练卡片(造猎手)"
    )
    ...
    override val TrainCard骷髅 = ColorSchema.parse(
        23, 429, 1279, 693, "102BC7",
        "5|2|0F27D5,-1|-11|7C7FE4,-2|-25|6970DC,18|-13|696DDC,17|-31|6970D9,28|-6|192484,29|-17|1A2D81,39|-24|363AB6",
        0, 0.9, "骷髅训练卡片(造骷髅)"
    )
